...
# because I am only focus on genotype difference in control condition with GABA defficient mutant, Thus I only use data in control condition with selected mutants
meta %<>% 
  filter(submergence == "cont") %>%
  # filter(!str_detect(genotype, "pop|OE")) %>% 
