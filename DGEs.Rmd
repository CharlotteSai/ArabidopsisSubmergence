...
# deRes %>%
#   bind_rows() %>%
#   mutate(comparison = ifelse(comparison != "gad1245_gad2",
#                              paste0(comparison,"-Col-0"),
#                              "gad1245-gad2")) %>% 
#   write_csv("./output_results/DGEList.csv")

# save.image("~/Library/CloudStorage/Box-Box/Bioinfo/ArabidopsisSubmergence/DGEs.RData")
```
